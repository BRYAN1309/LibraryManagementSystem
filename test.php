  ...
  <div class="flex h-screen">
    ...
    <nav class="w-72 bg-blue-900 text-white flex flex-col">
      ...
      <div class="mt-auto p-5">
        <a href="logout.php" class="flex items-center p-2 hover:bg-blue-700 rounded"><i class="fas fa-sign-out-alt w-6"></i><span class="ml-3">Log out</span></a>
      </div>
    </nav>
<?php
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                      <a href="delete.php?bookId=<?php echo $row['bookId']; ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
